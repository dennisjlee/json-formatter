JSONFormatter = (function(){
  ...
  var init = function(json, options){ 
    ...
    loopObjectOfObjects = function(json2, ulId) 
    {
      ...
      $.each(json2, function(k3, v3){
        ...
        if(typeof v3 == 'object'){
          ...
          $('#' + settings.listID + ' #' + ulId).append('<li><span>{</span> <ul id="' + ulId + '-' + k3 + '"></ul></li>');
          ...
          $.each(v3, function(k4, v4){
            ...
            if(typeof v4 == 'object' && v4 != null) 
            {
              ...
              $('#' + settings.listID + ' #' + ulId + '-' + k3).append('<li>' + k4 + ' <span>{</span> <ul id="' + k4 + '-' + loopCount + '"></ul></li>');
            ...
            else 
            {
              ...
              $('#' + settings.listID + ' #' + ulId + '-' + k3).append('<li>' + k4 + ': ' + v4 + '</li>');
        ...
        else 
        {
          ...
          // normal array
          $('#' + settings.listID + ' #' + ulId).append('<li>' + v3 + '</li>');
      ...
      $.each(v, function(nextKey, nextVal){
        ...
        if(nextVal != null && typeof nextVal == 'object') 
        {
          ...
          if(nextVal.length == 0)
          {
            ...
            $('#' + settings.listID + ' #' + ulId).append('<li><i>' + nextKey + ':</i> {}</li>');
          ...
          else if(nextVal.length >= 1)
          {
            ...
            $('#' + settings.listID + ' #' + ulId).append('<li><b>' + nextKey + ':</b> <span>{</span> ' + newList + '</li>');
        ...
        else
        {
            ...
            $('#' + settings.listID + ' #' + ulId).append('<li><i>'+ nextKey + ':</i> ' + nextVal + '</li>');
    ...
    $(settings.element).html(jsonList);
    ...
    $.each(json, function(key, val){
      ...
      if(val != null && typeof val == 'object') 
      {
        ...
        if(goObj) 
        {
          ...
          $('#' + settings.listID).append('<li><b>' + key + ':</b> <span>{</span><ul id="' + nk + '-' + loopCount + '"></ul></li>');
